...
/obj/machinery/power/compressor/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "<hr><span class='notice'>The status display reads: Efficiency at <b>[efficiency*100]%</b>.</span>"
...
/obj/machinery/power/turbine/examine(mob/user)
	. = ..()
	if(in_range(user, src) || isobserver(user))
		. += "<hr><span class='notice'>The status display reads: Productivity at <b>[productivity*100]%</b>.</span>"
