...
/obj/item/reagent_containers/glass/maunamug/examine(mob/user)
	. = ..()
	. += "<hr><span class='notice'>The status display reads: Current temperature: <b>[reagents.chem_temp]K</b> Current Charge:[cell ? "[cell.charge / cell.maxcharge * 100]%" : "No cell found"].</span>"
	if(open)
		. += "<hr><span class='notice'>The battery case is open.</span>"
