...
/obj/item/clothing/suit/space/hostile_environment/process()
	...
	if(istype(C) && prob(2)) //cursed by bubblegum
		if(prob(10))
			...
			to_chat(C, "<span class='colossus'><b>[pick("I AM IMMORTAL.","I SHALL TAKE BACK WHAT'S MINE.","I SEE YOU.","YOU CANNOT ESCAPE ME FOREVER.","DEATH не может содержать ME.")]</b></span>")
		else
