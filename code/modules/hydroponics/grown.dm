...
//Ghetto Seed Extraction
	switch(O.tool_behaviour)
		if(TOOL_SCREWDRIVER)
			...
			user.visible_message("<span class='notice'>[user] starts digging into [src].</span>", "<span class='notice'>You start digging into [src]...</span>", "<span class='hear'>You hear the sound of a sharp object penetrating some plant matter.</span>")
		...
		if(TOOL_WIRECUTTER)
			playsound(loc, 'sound/weapons/bite.ogg', 50, TRUE, -1)
			user.visible_message("<span class='notice'>[user] starts nipping into [src].</span>", "<span class='notice'>You start nipping into [src]...</span>", "<span class='hear'>You hear the sound of a sharp object penetrating some plant matter.</span>")
			if(do_after(user, 28, target = src))
		...
		if(TOOL_CROWBAR)
			...
			user.visible_message("<span class='notice'>[user] starts splitting [src].</span>", "<span class='notice'>You dig into [src] and start to split it...</span>", "<span class='hear'>You hear the sound of a sharp object digging into some plant matter.</span>")
		...
		if(TOOL_WRENCH)
			...
			user.visible_message("<span class='notice'>[user] starts whacking [src].</span>", "<span class='notice'>You start whacking [src]...</span>", "<span class='hear'>You hear the sound of a plant being whacked violently.</span>")
	...
	if(!slice_path)
		if(O.get_sharpness())
			playsound(loc, 'sound/weapons/slice.ogg', 50, TRUE, -1)
			user.visible_message("<span class='notice'>[user] starts slicing apart [src].</span>", "<span class='notice'>You start slicing apart [src]...</span>", "<span class='hear'>You hear the sound of a sharp object slicing some plant matter.</span>")
