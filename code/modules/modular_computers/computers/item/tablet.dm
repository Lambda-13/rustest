...
/obj/item/modular_computer/tablet/nukeops/emag_act(mob/user)
	if(!enabled)
		...
		return FALSE
	to_chat(user, "<span class='notice'>You swipe [src]. It's screen briefly shows a message reading \"MEMORY CODE INJECTION DETECTED AND SUCCESSFULLY QUARANTINED\".</span>")
	return FALSE
