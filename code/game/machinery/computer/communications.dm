...
/obj/machinery/computer/communications/proc/has_communication()
	...
	return istype(get_area(src), /area/ship) || is_centcom_level(current_turf) || is_reserved_level(current_turf) || istype(get_area(src), /area/ruin/space/has_grav/ancientstation) || istype(get_area(src), /area/outpost)
