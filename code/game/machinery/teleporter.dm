...
/obj/machinery/teleport/hub/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "<hr><span class='notice'>The status display reads: Probability of malfunction decreased by <b>[(accuracy*25)-25]%</b>.</span>"
...
/obj/machinery/teleport/station/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "<hr><span class='notice'>The status display reads: This station can be linked to <b>[efficiency]</b> other station(s).</span>"
