...
/area/outpost
	...
	area_flags = VALID_TERRITORY | BLOBS_ALLOWED | NOTELEPORT | SAFEZONE // not unique, in case multiple outposts get loaded. all derivatives should also be NOTELEPORT
...
/area/hangar
	...
	area_flags = UNIQUE_AREA | NOTELEPORT | HIDDEN_AREA | SAFEZONE
	sound_environment = SOUND_AREA_LARGE_ENCLOSED
	dynamic_lighting = DYNAMIC_LIGHTING_FORCED
	has_gravity = STANDARD_GRAVITY
