...
/obj/structure/spider/spiderling/process()
	...
	//=================
		...
		if(nearby.len)
			...
			if(prob(40))
				src.visible_message("<span class='notice'>[src] skitters[pick(" away"," around","")].</span>")
	else if(prob(10))
		//ventcrawl!
...
/obj/structure/spider/cocoon/container_resist_act(mob/living/user)
	...
	visible_message("<span class='notice'>You see something struggling and writhing in [src]!</span>")
...
/obj/structure/spider/cocoon/Destroy()
	...
	src.visible_message("<span class='warning'>[src] splits open.</span>")
