...
/obj/item/desynchronizer/examine(mob/user)
	...
	. += "<hr><span class='notice'>Alt-клик to customize the duration. Current duration: [DisplayTimeText(duration)].</span>"
	. += "<hr><span class='notice'>Can be used again to interrupt the effect early. The recharge time is the same as the time spent in desync.</span>"
