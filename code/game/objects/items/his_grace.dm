	...
	if(awakened)
		switch(bloodthirst)
			if(HIS_GRACE_SATIATED to HIS_GRACE_PECKISH)
				. += "<hr><span class='his_grace'>[src] isn't very hungry. Not yet.</span>"
			if(HIS_GRACE_PECKISH to HIS_GRACE_HUNGRY)
				. += "<hr><span class='his_grace'>[src] would like a snack.</span>"
			if(HIS_GRACE_HUNGRY to HIS_GRACE_FAMISHED)
				. += "<hr><span class='his_grace'>[src] is quite hungry now.</span>"
			if(HIS_GRACE_FAMISHED to HIS_GRACE_STARVING)
				. += "<hr><span class='his_grace'>[src] is openly salivating at the sight of you. Be careful.</span>"
			if(HIS_GRACE_STARVING to HIS_GRACE_CONSUME_OWNER)
				. += "<hr><span class='his_grace bold'>You walk a fine line. [src] is very close to devouring you.</span>"
			if(HIS_GRACE_CONSUME_OWNER to HIS_GRACE_FALL_ASLEEP)
				. += "<hr><span class='his_grace bold'>[src] is shaking violently and staring directly at you.</span>"
	else
		. += "<hr><span class='his_grace'>[src] is latched closed.</span>"
