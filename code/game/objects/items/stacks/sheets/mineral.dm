...
GLOBAL_LIST_INIT(diamond_recipes, list ( \
	...
	new/datum/stack_recipe("diamond ingot", /obj/item/ingot/diamond, 1), \
	))
...
GLOBAL_LIST_INIT(uranium_recipes, list ( \
	...
	new/datum/stack_recipe("uranium ingot", /obj/item/ingot/uranium, 1), \
	))
...
GLOBAL_LIST_INIT(plasma_recipes, list ( \
	...
	new/datum/stack_recipe("plasma ingot", /obj/item/ingot/plasma, 1), \
	))
...
GLOBAL_LIST_INIT(gold_recipes, list ( \
	...
	new/datum/stack_recipe("gold ingot", /obj/item/ingot/gold, 1), \
	))
...
GLOBAL_LIST_INIT(silver_recipes, list ( \
	...
	new/datum/stack_recipe("silver ingot", /obj/item/ingot/silver, 1), \
	))
...
GLOBAL_LIST_INIT(bananium_recipes, list ( \
	...
	new/datum/stack_recipe("hilarious ingot", /obj/item/ingot/bananium, 1), \
	))
...
GLOBAL_LIST_INIT(titanium_recipes, list ( \
	...
	new/datum/stack_recipe("titanium ingot", /obj/item/ingot/titanium, 1), \
	))
...
GLOBAL_LIST_INIT(adamantine_recipes, list(
	...
	new/datum/stack_recipe("adamantine ingot", /obj/item/ingot/adamantine, 1), \
	))
