...
/obj/structure/grille/examine(mob/user)
	. = ..()
	if(anchored)
		. += "<hr><span class='notice'>It's secured in place with <b>screws</b>. The rods look like they could be <b>cut</b> through.</span>"
	if(!anchored)
		. += "<hr><span class='notice'>The anchoring screws are <i>unscrewed</i>. The rods look like they could be <b>cut</b> through.</span>"
