...
/proc/AnnounceArrival(mob/living/carbon/human/character, rank, datum/overmap/ship/controlled/ship)
	...
	deadchat_broadcast("<span class='game'> теперь стал членом судна <span class='name'>[ship.name]</span> в <span class='name'>[A.name]</span>.</span>", "<span class='game'><span class='name'>[character.real_name]</span> ([rank])</span>", follow_target = character, message_type=DEADCHAT_ARRIVALRATTLE)
