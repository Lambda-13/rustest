...
#define ADMIN_PUNISHMENT_BREAK_BONES "Похрустеть всеми косточками"
#define ADMIN_PUNISHMENT_LIGHTNING "Поймать молнию"
#define ADMIN_PUNISHMENT_BRAINDAMAGE "Поиграть на сс220 (бреиндамаг)"
#define ADMIN_PUNISHMENT_GIB "ГИБНУТЬ НАХУЙ"
...
#define ADMIN_PUNISHMENT_NYA "Сделать ванотяном"
#define ADMIN_PUNISHMENT_FURRYFICATION "Фуррификация (ПИЗДЕЦ ДО КОНЦА РАУНДА)"
