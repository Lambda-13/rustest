...
/obj/item/disk/holodisk/lp/retrieval/gunstock
	...
	SAY Эта миссия, если вы решите ее принять, вращается вокруг поисковой цели. LP нужно будет получить или создать что-то.
	DELAY 25
	SAY Нанотрайзен прислал вам очень ограниченный запас оружия. Увеличьте его. Мы хотим, чтобы в вашем хранилище хранилось пять уникальных орудий.
	DELAY 25
	"}
...
/obj/item/disk/holodisk/lp/aid/telecomm
	name = "Aid Mission Telecomms"
	desc = "A holodisk containing an aid mission for the LP."
	preset_image_type = /datum/preset_holoimage/commissioner
	preset_record_text = {"
	NAME Commissioner Gorre Donn
	SAY This mission, should you choose to accept it, revolves around an aid objective. The LP will need to provide aid to local vessels not hostile or syndicate.
	DELAY 25
	SAY Of the possible duties for a Ranger-Class, this one is of the utmost utility. Cross space telecommunications is one of the most important things a vessel could have. Set it up on 3 other allied or otherwise friendly and non-syndicate vessels.
	DELAY 25
	"}
...
/obj/item/disk/holodisk/lp/aid/rescure
...
/obj/item/disk/holodisk/lp/aid/ai
	name = "Aid Mission Artifical Intelligence"
	desc = "A holodisk containing an aid mission for the LP."
	preset_image_type = /datum/preset_holoimage/commissioner
	preset_record_text = {"
	NAME Commissioner Gorre Donn
	SAY This mission, should you choose to accept it, revolves around an aid objective. The LP will need to provide aid to local vessels not hostile or syndicate.
	DELAY 25
	SAY AI's are a massive boon to any vessel. Install one on 2 other allied or otherwise friendly, non-syndicate vessels.
	DELAY 25
	"}
...
/obj/item/disk/holodisk/lp/aid/ripley
	name = "Aid Mission Ripleys in Aid"
	desc = "A holodisk containing an aid mission for the LP."
	preset_image_type = /datum/preset_holoimage/commissioner
	preset_record_text = {"
	NAME Commissioner Gorre Donn
