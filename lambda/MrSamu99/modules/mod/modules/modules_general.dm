...
/obj/item/mod/module/storage/proc/on_chestplate_unequip(obj/item/source, force, atom/newloc, no_move, invdrop, silent)
	...
	if(atom_storage?.handle_item_insertion(mod.wearer.s_store, mod.wearer))//, override = TRUE))
