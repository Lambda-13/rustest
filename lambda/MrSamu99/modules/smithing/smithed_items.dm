...
/obj/item/smithing/knifeblade/startfinish()
	...
	finalitem.icon = 'lambda/MrSamu99/icons/smithing/smith.dmi'
	finalitem.icon_state = "dagger"
	finalitem.name = "dagger"
	finalitem.desc = "A dagger."
	var/mutable_appearance/overlay = mutable_appearance('lambda/MrSamu99/icons/smithing/smith.dmi', "daggerhilt")
