...
/obj/item/forging/incomplete/prospector_pickaxe
	name = "incomplete prospector's pickaxe"
	icon_state = "hot_pickaxehead"
	spawn_item = /obj/item/forging/complete/prospector_pickaxe

/*obj/item/forging/incomplete/rail_cart
	name = "incomplete rail cart"
	icon = 'lambda/MrSamu99/modules/ashwalkers/icons/railroad.dmi'
	icon_state = "hot_cart"
...
/obj/item/forging/complete/prospector_pickaxe
	name = "prospector's pickaxe head"
	desc = "A prospector's pickaxe head, ready to get some wood for completion."
	icon_state = "pickaxehead"
	spawning_item = /obj/item/prospector_pickaxe
...
/obj/item/forging/incomplete_bow/attackby(obj/item/attacking_item, mob/user, params)
	if(istype(attacking_item, /obj/item/weaponcrafting/silkstring))
		new /obj/item/gun/ballistic/bow/ashen(get_turf(src))
		qdel(attacking_item)
		qdel(src)
		return
	return ..()
