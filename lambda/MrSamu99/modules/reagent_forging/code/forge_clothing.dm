...
/obj/item/clothing/suit/armor/forging_plate_armor
	...
	icon = 'lambda/MrSamu99/modules/reagent_forging/icons/obj/forge_clothing.dmi'
	mob_overlay_icon = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/clothing/forge_clothing.dmi'
	icon_state = "plate_vest"
	supports_variations = DIGITIGRADE_VARIATION_NO_NEW_ICON
	resistance_flags = FIRE_PROOF
	obj_flags = ANVIL_REPAIR
	armor = list("melee" = 40, "bullet" = 40, "fire" = 50)
...
/obj/item/clothing/head/helmet/forging_plate_helmet
	...
	//supports_variations = CLOTHING_SNOUTED_VARIATION_NO_NEW_ICON
	resistance_flags = FIRE_PROOF
	flags_inv = null
	obj_flags = ANVIL_REPAIR
	armor = list("melee" = 40, "bullet" = 40, "fire" = 50)
...
/obj/item/clothing/shoes/forging_plate_boots
	...
	icon = 'lambda/MrSamu99/modules/reagent_forging/icons/obj/forge_clothing.dmi'
	mob_overlay_icon = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/clothing/forge_clothing.dmi'
	worn_icon_digi = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/clothing/forge_clothing_digi.dmi'
	icon_state = "plate_boots"
	supports_variations = DIGITIGRADE_VARIATION
	armor = list("melee" = 20, "bullet" = 20)
	material_flags = MATERIAL_ADD_PREFIX | MATERIAL_COLOR
	resistance_flags = FIRE_PROOF
	obj_flags = ANVIL_REPAIR
	can_be_tied = FALSE
...
/obj/item/clothing/neck/collar/reagent_clothing
	...
	//icon = 'lambda/MrSamu99/modules/modular_items/lewd_items/icons/obj/lewd_clothing/lewd_neck.dmi'
	//mob_overlay_icon = 'lambda/MrSamu99/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_neck.dmi'
