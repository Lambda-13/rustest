/obj/item/forging/reagent_weapon
	icon = 'lambda/MrSamu99/modules/reagent_forging/icons/obj/forge_items.dmi'
	lefthand_file = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/forge_weapon_l.dmi'
	righthand_file = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/forge_weapon_r.dmi'
	worn_icon = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/forge_weapon_worn.dmi'
	material_flags = MATERIAL_ADD_PREFIX | MATERIAL_COLOR
	obj_flags = ANVIL_REPAIR
...
/obj/item/forging/reagent_weapon/staff //doesn't do damage. Useful for healing reagents.
	...
	mob_overlay_state = "staff_back"
	throwforce = 0
	slot_flags = ITEM_SLOT_BACK
	w_class = WEIGHT_CLASS_NORMAL
	resistance_flags = FIRE_PROOF
	//attack_verb_continuous = list("bonks", "bashes", "whacks", "pokes", "prods")
	attack_verb = list("bonk", "bash", "whack", "poke", "prod")
...
/obj/item/forging/reagent_weapon/spear
	...
	attack_verb = list("attack", "poke", "jab", "tear", "lacerate", "gore")
	reach = 2
...
/obj/item/forging/reagent_weapon/hammer
	...
	mob_overlay_state = "hammer_back"
	throwforce = 10
	slot_flags = ITEM_SLOT_BACK
	w_class = WEIGHT_CLASS_BULKY
	resistance_flags = FIRE_PROOF
	//attack_verb_continuous = list("bashes", "whacks")
	attack_verb = list("bash", "whack")
...
/obj/item/forging/reagent_weapon/hammer/attack_obj(obj/attacked_atom, mob/living/user)
	. = ..()
...
/obj/item/shield/buckler/reagent_weapon //Same as a buckler, but metal.
	...
	mob_overlay_state = "buckler_back"
	lefthand_file = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/forge_weapon_l.dmi'
	righthand_file = 'lambda/MrSamu99/modules/reagent_forging/icons/mob/forge_weapon_r.dmi'
...
/obj/item/prospector_pickaxe
	desc = "A small that checks surrounding rock for useful minerals; it can also be used to stop gibtonite detonations."
	name = "prospector's pickaxe"
	icon = 'lambda/MrSamu99/icons/smithing/smith.dmi'
	icon_state = "minipick" //todo:sprite
	sharpness = IS_SHARP_ACCURATE//it doesnt have a blade it has a point
	icon_state = "mining1"
	item_state = "analyzer"
...
/obj/item/prospector_pickaxe/Initialize(mapload)
	. = ..()
...
/obj/item/prospector_pickaxe/attack_self(mob/user)
	if(!user.client)
		return
	if(current_cooldown <= world.time)
		current_cooldown = world.time + cooldown
		mineral_scan_pulse(get_turf(user), world.view/2)
