/obj/machinery/cell_charger_multi
	...
	icon = 'lambda/MrSamu99/modules/multicellcharger/icons/cell.dmi'
...
/obj/machinery/cell_charger_multi/process(delta_time)
	...
	for(var/obj/item/stock_parts/cell/charging in charging_batteries)
		...
		use_power(main_draw)//charge_rate / 100) //use a small bit for the charger itself, but power usage scales up with the part tier
...
/obj/machinery/cell_charger_multi/RefreshParts()
	...
	for(var/obj/item/stock_parts/capacitor/capacitor in component_parts)
		charge_rate += charge_rate_base * capacitor.rating
