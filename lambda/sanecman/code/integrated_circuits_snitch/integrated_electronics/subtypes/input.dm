...
/obj/item/integrated_circuit_old/input/yoheidetector
	complexity = 18
	name = "Magic Finder"
	desc = "Детектор магической ауры около себя."
	extended_desc = "Обнаруживает магические штучки вокруг себя. Класс."
...
//	RegisterSignal(src, COMSIG_COMPONENT_NTNET_RECEIVE, PROC_REF(ntnet_receive)) // Не подхватывает
